...
public class Netinteractutils {
    ...
    private static Netinteractutils instance;
    ...
    public void setGetEvaluationCallback(EvaluationCallback evaluationCallback) {
    ...
    public void setGetEvaluationsCallback(EvaluationsCallback evaluationsCallback) {
    ...
    public void setGetEvaluationIDsCallback(EvaluationIDsCallback evaluationIdsCallback) {
    ...
    public void setGetUserIDsCallback(UserIDsCallback userIdsCallback) {
    ...
    public void setGetUserInfoCallback(UserInfoCallback userInfoCallback) {
