...
String[] RG_Ans = {"B","C","B","C","D",
    ...
    public static String[] SOCIAL_contents = {
        ...
        "孩子能理解并尊重他人的表情和情绪\n例，知道别人不开心时，不能继续闹或抢。",
        "孩子能理解并按照社交模式轮流说话\n例，知道别人说完再说，不总是插话。",
        "孩子能和其他孩子一起玩，并保持一段时间的互动\n例，和小朋友一起搭积木、玩玩具，能玩一会儿。",
        "孩子能描述自己或他人的经历，并理解其中的情绪\n例，能说\"我昨天去公园，很开心\"，或者\"他摔了，所以哭了\"。",
        "孩子能理解别人可能有不同想法\n例，知道别人可能喜欢不同的玩具或游戏。",
        "孩子能根据不同场景调整自己的行为\n例，在图书馆会安静，在操场会跑跳。",
        "当和其他孩子发生小矛盾时，孩子能在大人引导下解决\n例，和小朋友抢玩具时，在大人提醒下能轮流玩或交换。",
        "孩子会主动邀请别人一起玩，或组织简单活动\n例，会说\"我们一起玩吧\"，或者提议\"我们玩这个吧\"。",
        "孩子能和两个或更多小朋友一起聊天或玩耍\n例，和几个小朋友围坐在一起，轮流说话或一起玩游戏。",
        "孩子能理解并遵守集体规则\n例，排队时能等待，游戏时能遵守规则。",
        "孩子能和别人进行较长时间的对话\n例，能回答问题，也能主动提问，保持对话流畅。",
        "孩子会关心别人，在别人需要时提供帮助\n例，看到别人摔倒，会说\"你没事吧\"，或者去扶。",
        "孩子能理解并使用更复杂的对话规则\n例，会用\"我觉得\"\"我想\"表达自己的想法，会倾听别人说话。",
        "孩子能识别并回应别人更复杂的情绪\n例，能看出别人害羞、失望，会说\"你别难过\"。",
        "孩子能和同伴一起设定目标并合作完成\n例，一起搭积木塔，会分工合作，互相帮忙。",
        "孩子能理解别人的想法可能与自己不同\n例，知道别人可能有不同的喜好或观点。",
        "孩子能尝试解决社交中的小问题\n例，和朋友吵架后，会主动说\"对不起\"，或者提出和解。",
        "孩子能理解别人行为的原因\n例，知道别人为什么生气、难过，能说出原因。",
        "孩子能组织语言，表达较复杂的想法\n例，能讲述较长的故事，或解释自己的想法。",
        "孩子能理解并遵守社会规则，有基本责任感\n例，能主动收拾玩具，遵守公共场合规则。",
        "孩子能自主管理与他人的互动\n例，能自己解决小矛盾，不需要大人一直帮忙。",
        "孩子能和同伴一起制定计划并执行\n例，一起策划游戏，分配角色，按计划进行。",
        "当沟通出现问题时，孩子能尝试修复\n例，没听清楚时会说\"你再说一遍\"，或者解释自己的意思。",
        "孩子能理解并回应别人复杂的情绪\n例，能看出别人的尴尬、自豪，会给予适当回应。",
        "孩子能根据社交情境做出合理判断\n例，知道在什么场合说什么话，做什么事。",
        "孩子能面对社交问题并尝试解决\n例，遇到冲突时，能提出解决方案，如轮流、交换等。",
        "孩子能根据不同情境控制自己的行为\n例，在需要安静的场合能保持安静，在游戏时能适当活跃。",
        "孩子能理解别人的复杂想法和感受\n例，能理解别人可能有隐藏的情绪，或不同的观点。",
        "孩子能与同伴协商解决问题，共同做决定\n例，和朋友一起商量玩什么游戏，能妥协和达成一致。"
    };
}
