...
public class mainactivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private LinearLayout changeMoule;
    ...
    private TextView changeMouleno;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        changeMoule = findViewById(R.id.btn_changeModule);
        ...
        changeMouleno = findViewById(R.id.changeModule_no);
        ...
        changeMoule.setOnClickListener(this);
        ...
        if(isTest){
            ...
            changeMoule.setVisibility(View.GONE);
        }else{
