...
public class AssessmentModule implements Serializable {
    ...
    private int progressStatus; // 进度状态（未开始/进行中/已完成）
    ...
    public AssessmentModule(String id, String title, String description, String timeEstimate, int iconResId) {
        ...
        this.lastTestDate = "";
        this.progressStatus = STATUS_NOT_STARTED;
    }
    ...
    public void setCompleted(boolean completed) {
        ...
        if (completed) {
            this.progressStatus = STATUS_COMPLETED;
        }
    }
    ...
    public void setProgressStatus(int progressStatus) {
        ...
        if (progressStatus == STATUS_COMPLETED) {
